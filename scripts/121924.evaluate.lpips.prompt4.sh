...
<<COMMENT
Llama-3.1-8B-Instruct.200
Llama-3.3-70B-Instruct.200
Llama-3.1-70B-Instruct.200
Qwen2.5-72B-Instruct.200
Phi-3.5-mini-instruct.200
COMMENT
...
summarize_model_name=Llama-3.1-8B-Instruct.200
...
summarize_model_name=Llama-3.1-70B-Instruct.200
reference_dir=$project/wit_images_2k/
generated_dir=$project/generated_images/$pattern/$model_name/$summarize_model_name/
...
summarize_model_name=Qwen2.5-72B-Instruct.200
reference_dir=$project/wit_images_2k/
generated_dir=$project/generated_images/$pattern/$model_name/$summarize_model_name/
...
summarize_model_name=Phi-3.5-mini-instruct.200
reference_dir=$project/wit_images_2k/
generated_dir=$project/generated_images/$pattern/$model_name/$summarize_model_name/
